...
const SEED_SUBMISSIONS: Partial<VerificationStore> = {
  buyer: {
    ...
    documents: [
      { id: "governmentId", name: "vikram-passport.pdf", size: 812_000, required: true, reviewStatus: "approved", reviewNote: null, dataUrl: null },
      { id: "gstin", name: "meridian-gstin.pdf", size: 245_000, required: true, reviewStatus: "approved", reviewNote: null, dataUrl: null },
      { id: "bankDetails", name: "meridian-bank-letter.pdf", size: 190_000, required: false, reviewStatus: "approved", reviewNote: null, dataUrl: null },
    ],
  ...
  seller: {
    ...
    documents: [
      { id: "governmentId", name: "ravi-aadhaar.pdf", size: 540_000, required: true, reviewStatus: "approved", reviewNote: null, dataUrl: null },
      { id: "iecCode", name: "ravi-iec-code.pdf", size: 210_000, required: true, reviewStatus: "approved", reviewNote: null, dataUrl: null },
      { id: "taxRegistration", name: "ravi-gst-certificate.pdf", size: 275_000, required: true, reviewStatus: "approved", reviewNote: null, dataUrl: null },
      { id: "bankDetails", name: "ravi-bank-details.pdf", size: 165_000, required: false, reviewStatus: "approved", reviewNote: null, dataUrl: null },
    ],
