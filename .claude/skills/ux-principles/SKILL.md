---
name: ux-principles
description: "Nielsen's usability heuristics, user-centered design, accessibility/inclusive design, user research, and UX metrics. Use when designing or reviewing any IMS screen or flow, justifying a UI/UX decision, or evaluating usability — before proposing layout, navigation, or interaction changes."
category: design
tags: [ux, user-research, usability, accessibility, design-thinking, user-testing]
version: 1.0.0
source: "https://github.com/manutej/luxor-claude-marketplace/tree/main/plugins/luxor-design-toolkit/skills/ux-principles"
---

# UX Principles Skill

Worked examples for every heuristic and framework below are in `references/examples.md` — consult it before applying a principle to unfamiliar UI.
